...
def on_connect(client, userdata, flags, rc):
    ...
    client.publish("robot", "Neurosky connected")
            ...
            if control_mode is True:
                if takeoff_flag is False:
                    if attention_duration >= duration_off:
                        ...
                        if mqtt_connected:
                            mqttClient.publish("robot", mqtt_command)
                        takeoff_flag = True
                        attention_duration = 0
                    ...
                    if attention_duration == duration_level1:
                        ...
                        # print('level2')
                        m_event_update('side-kick')
                        if mqtt_connected:
                            mqtt_command = 'side-kick'
                            mqttClient.publish("robot", mqtt_command)
